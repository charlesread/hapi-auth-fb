...
module.exports = function (server, options) {
  ...
  _options.fb = {
    ...
    dialogUrl: `https://www.facebook.com/v${_options.version}/dialog/oauth?client_id=${_options.client_id}&redirect_uri=${_options.appUrl}${_options.handlerPath}&scope=${_options.scope}`
  }
  return _options
}